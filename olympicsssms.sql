...
Select distinct Year, count(distinct region)as no_of_nations from nations
Group by Year
Order by 1 asc
...
Select Sum(no_of_countries) as participation, Games from cte
Group By Games
Order By 1 asc /* To find the highest no. of countries participating, write desc instead of asc */
